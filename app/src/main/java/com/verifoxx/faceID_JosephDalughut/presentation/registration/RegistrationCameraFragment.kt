 ...
 * Use the [RegistrationCameraFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RegistrationCameraFragment : Fragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() =
            RegistrationCameraFragment().apply {
    ...
    private lateinit var binding: FragmentRegistrationCameraBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentRegistrationCameraBinding.inflate(inflater)
        return binding.root
    }
